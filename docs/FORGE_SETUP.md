...
port = 9080          # Port for webhook endpoint
```
...
- **GitHub**: `http://your-server:9080/api/webhook/github`
- **GitLab**: `http://your-server:9080/api/webhook/gitlab`
...
**Check:**
- Server is running: `curl http://localhost:9080/`
